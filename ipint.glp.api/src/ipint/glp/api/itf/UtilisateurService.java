...
public interface UtilisateurService {
	 ...
	 * @param utilisateur l'utilisateur à trouver
	 ...
	 */
	/** Modifier un utilisateur
	 * @param ancienUtilisateur l'utilisateur à modifier
	 * @param nouvelUtilisateur le nouvel utilisateur avec les mises à jour
